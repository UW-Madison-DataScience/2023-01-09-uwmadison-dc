...
humandate: "January 9-12, 2023"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Mariah Knowles", "Casey Schacher", "Erwin Lares", "Chris Endemann"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Heather Shimon", "Immad Shah"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2023-01-09-uwmadison-dc # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
eventbrite: 480085607977          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
